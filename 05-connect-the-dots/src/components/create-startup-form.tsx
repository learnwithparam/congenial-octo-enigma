    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
      ...
      <div>
        ...
        <input
          ...
          className={
            'w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-900 dark:text-gray-100 ' +
            (errors.name
              ? 'border-red-500'
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChange}
          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700"
